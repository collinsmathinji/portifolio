...
import { Code, Database, Server, Layout, GitBranch, Terminal, Layers, Globe, BarChart } from "lucide-react"
...
const skills = [
  ...
  },
  {
    ...
    tech: "Node.js, Express,Nest.js,fastify,stripe Payment system",
  ...
  },
  {
    ...
    tech: "MongoDB, Mongoose,SQL,supabase,Dynamo DB",
  ...
  },
  {
    ...
    tech: "Chart.js, D3.js",
    description: "Creating interactive and insightful data visualizations for complex information.",
    color: "text-red-500",
  },
  {
    icon: Globe,
    name: "Web3 Technologies",
    tech: "Blockchain Basics",
    description: "Exploring blockchain technologies and their integration with traditional web applications.",
  ...
  },
  {
    ...
    description: "Crafting beautiful and responsive interfaces that work across all devices.",
    color: "text-pink-500",
  },
  {
    icon: GitBranch,
